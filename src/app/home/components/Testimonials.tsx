    ...
    <Section className="bg-(--teal)">
      <div className="py-10 sm:py-20 " aria-label="About Us">
        <div className="h-full relative lg:pb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 bg-amber-300   mt-10 h-full">
            <div className=" flex items-center justify-center lg:justify-start xl:justify-center bg-amber-950 ">
              <div className="w-[350px] lg:w-[300px] xl:w-[350px] h-[450px] relative isolate">
                {/* Main Image */}
                ...
                <div className="absolute bottom-0 right-0 translate-x-1/2 translate-y-1/3 z-50">
                  <Image
                    ...
                    width={200}
                    height={250}
                    className="object-cover w-[200px] h-[250px] rounded-full"
                  />
                </div>

                {/* Circle Border (behind everything) */}
                <div className="w-32 h-32 border-4 border-white rounded-full absolute bottom-0 left-0 -translate-x-1/6 translate-y-1/6 z-0">
            ...
            <div className="relative flex flex-col w-full items-center bg-amber-600 mt-10 justify-center">
              <Swiper
                className="mySwiper w-full h-full my-10"
              ...
              >
                <SwiperSlide className="p-6 bg-white rounded-xl shadow flex flex-col gap-4 justify-between h-full">
                  ...
                  <Paragraph size="base" className="italic">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                    Enim incidunt veritatis vitae assumenda? Quia ipsa incidunt,
                    dolorum earum doloribus provident amet eum praesentium
                    eveniet aperiam tempore explicabo, labore ab dolores magni
                    rem assumenda illum rerum? Nisi, dicta veniam. Labore cumque
                    enim odio amet cupiditate dicta sapiente explicabo, nisi
                    eligendi hic perferendis nostrum temporibus distinctio optio
                    quas maiores, pariatur incidunt modi doloremque! Amet iure
                    nam ipsam consequuntur provident.
                  </Paragraph>
