            ...
            <div className="py-10 sm:py-20 " aria-label="About Us">
                ...
                <div className="h-full relative pb-20">
                    <div className="max-w-3xl mx-auto">
                        <Heading level={4} className="font-bold leading-tight text-center text-white">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-14   mt-10 h-full">
                        <div className=" flex items-center justify-center ">
                            <div className="w-[350px] h-[450px] relative isolate">
                                {/* Main Image */}
                            ...
                            >
                                ...
                                <SwiperSlide className="p-6 bg-white rounded-xl shadow flex flex-col gap-4 justify-between h-full">
                                    <div className="flex items-center gap-3">
                                        <Image src="/home/aboutus-1.jpg" alt="Marvin McKinney" width={48} height={48} className="rounded-full object-cover" />
                                        <div className="border-l-3 border-(--orange) pl-3">
                                            <Paragraph size="lg" className="font-bold ">Marvin McKinney</Paragraph>
                                            <Span>15th Batch Students</Span>
                                        </div>
                                        <span className="ml-auto text-4xl text-black/20 font-bold select-none"><BiSolidQuoteRight /></span>
                                    </div>
