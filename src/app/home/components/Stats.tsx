...
const Stats: React.FC = () => {
  ...
  return (
    <section className="max-w-xs sm:max-w-xl md:max-w-2xl lg:max-w-4xl mx-auto px-0 md:px-4 lg:px-12 xl:px-0">
      <div className="grid grid-cols-1 lg:gap-8 message-content bg-(--teal) rounded-tl-[70px] rounded-br-[70px]">
        <div ref={ref} className="flex flex-col sm:flex-row justify-between text-(--white) gap-6 sm:gap-2 py-2 lg:py-0 px-10">
          {stats.map((stat) => (
