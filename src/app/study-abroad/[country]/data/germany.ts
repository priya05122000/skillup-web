...
const germany: CountryData = {
  name: "Germany",
  bannerTitle: "Study Abroad in Germany",
  bannerSubtitle: "Explore Your Future in Germany",
  capital: "Berlin",
  ...
  currency: "EUR",
  educationSystem: [
    "The education system in Germany is decentralized, with each state having its own system of public education.",
